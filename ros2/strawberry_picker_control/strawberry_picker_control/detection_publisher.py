...
class YoloV8CamNode(Node):
    def __init__(self):
        ...
        # Open the camera
        self.cap = cv2.VideoCapture("http://10.24.150.100:5000/video_feed")
        ...
        self.show_window = False  # Set to False for headless operation
    ...
    def timer_callback(self):
        ...
        output_path = "/home/user/ros2_ws/output_image.jpg"
        ...
        # Show both original and annotated frames (disabled for headless operation)
        # if self.show_window:
        #     # Show original frame
